...
CREATE TABLE IF NOT EXISTS notafiscal (
    PRIMARY KEY (nf_num),
    nf_num INT NOT NULL AUTO_INCREMENT,
    nf_dataemissao DATE,
    nf_tipo VARCHAR(45),
    pedido_id INT NOT NULL,
    FOREIGN KEY (pedido_id) REFERENCES pedido(pedido_id) ON DELETE CASCADE -- para garantir que, ao excluir um pedido, as notas fiscais associadas também sejam excluídas
);
...
CREATE TABLE IF NOT EXISTS produto (
    ...
    preco_preco FLOAT DEFAULT 0.00,
